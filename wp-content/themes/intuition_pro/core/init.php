...
if(!function_exists('cpotheme_add_styles')){
	...
	function cpotheme_add_styles(){
		...
		wp_register_style('cpotheme-linearicons', $stylesheets_path.'icon-linearicons.css');
		wp_register_style('cpotheme-typicons', $stylesheets_path.'icon-typicons.css');
	}
}
...
require_once($core_path.'classes/class_updater.php');
