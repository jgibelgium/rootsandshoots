...
<div id="redbar" class="alert-info">
        <strong>&nbsp;<?php if(empty($_POST['projectid'])){echo "Add project";} else {echo "Update project";}?></strong>
...
<form id="frmProject" method="POST" action="http://localhost:8080/rootsandshootseurope/wp-content/plugins/rootsandshoots/appcode/webapp/control/project.control.php" class="form-horizontal" enctype="multipart/form-data">
